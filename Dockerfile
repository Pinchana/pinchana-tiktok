...
COPY pinchana-tiktok/pyproject.toml pinchana-tiktok/uv.lock pinchana-tiktok/README.md ./
...
EXPOSE 8081
CMD ["uv", "run", "uvicorn", "pinchana_tiktok.main:app", "--host", "0.0.0.0", "--port", "8081"]
